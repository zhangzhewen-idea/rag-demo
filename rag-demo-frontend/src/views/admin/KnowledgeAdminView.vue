    ...
    <el-dialog v-model="dialog" :title="editing ? '编辑知识库' : '新增知识库'" width="520">
      <el-form ref="formRef" :model="form" :rules="rules" label-position="top" @submit.prevent="save">
        ...
        <el-form-item label="封面图片" prop="coverUrl">
          <el-upload class="cover-uploader" :show-file-list="false" accept="image/png,image/jpeg,image/webp" :http-request="uploadCover">
...
.cover-preview { display: block; width: 160px; height: 100px; object-fit: cover; border: 1px solid var(--line); border-radius: 10px; }
.cover-help { display: block; margin-top: 8px; color: #827c89; }
</style>
