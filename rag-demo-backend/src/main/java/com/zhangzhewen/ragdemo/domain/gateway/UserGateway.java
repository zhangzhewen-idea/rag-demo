...
public interface UserGateway {
    ...
    /** 创建用户。 @return 新用户 ID */ Long create(String username, String password, String nickname, String avatarUrl, UserStatus status, Set<Role> roles);
    /** 更新用户资料。 */ void update(Long id, String nickname, String avatarUrl, UserStatus status, Set<Role> roles);
